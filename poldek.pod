...
If there is existing SOURCE/packages.dir[.gz] and it is diffrent from
current SOURCE/ content then program will create a "patch" file 
as SOURCE/packages.i/packages.dir.diff.YYYY.MM.DD-HH.MM.SS.gz
...
packages.dir, if it fails, then whole packages.dir is downloaded.

With B<--update-whole> program updates whole packages.dir
