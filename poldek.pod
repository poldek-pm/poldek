...
It was inspired by L<apt_get(8)> from Debian's APT, the interactive mode 
...
file (I<packages.dir> by default) and performs one of the following actions:
...
The other two files are created: packages.dir.md with computed packages.dir 
