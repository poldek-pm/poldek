...
The other two files are created: Packages.md with coputed Packages digest and 
Packages-toc with packages NAME-EVR per line.  
...
$ poldek -s /dir/with/RPMS/Packages -V apache
...
$ poldek -s ftp://ftp.dudy.net/RPMS/Packages -ti xteddy
